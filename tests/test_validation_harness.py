...
def test_score_case_computes_weighted_score_and_gaps(tmp_path):
    ...
    payload = {
        ...
        "checks": [
            ...
            {"id": "HELLO-A2", "status": "fail", "evidence": "wrong text", "gaps": ["wrong-output"]},
    ...
    case1 = score_case(
        parse_case_spec(Path("validation/specs/hello-cli.md")),
        {
            ...
            "checks": [
                ...
                {"id": "HELLO-A3", "status": "pass", "evidence": "ok"},
                {"id": "HELLO-A4", "status": "partial", "evidence": "weak", "gaps": ["missing-test"]},
                {"id": "HELLO-A5", "status": "pass", "evidence": "ok"},
            ],
            "raw_paths": {},
        },
    ...
    case2 = score_case(
        parse_case_spec(Path("validation/specs/file-transform.md")),
        {
            ...
            "checks": [
                ...
                {"id": "TRANSFORM-A4", "status": "partial", "evidence": "weak", "gaps": ["missing-test"]},
