    ...
    for group in groups:
        ...
        for step_index, step in enumerate(group.steps):
            ...
            fail_html = (
                ...
                f"<div class='cmp-fail-action'>{html.escape(BUILD_FAILURE_HINT)}</div>"
...
def render_target_switcher() -> str:
    ...
    return (
        ...
        "</span>"
        "<span class='fleet-btn-arrow'>&#9656;</span>"
        "</button>"
...
_STYLE = """
  ...
  .fleet-btn-arrow { font-size:11px; color:#64748b; font-weight:700; white-space:nowrap; }
