...
| L | Feedback | ANALYZE_COMPASS.md — target root, injection stack position 3 (after job block, before BLOCKERS.md); QuarterDeck shows it under ANALYSIS, editable, submit saves to file. |
...
| O | Feedback | Final injection stack — (1) prompt body (2) job block (3) `ANALYZE_COMPASS.md` (4) `BLOCKERS.md` (5) Rigging catalog filenames (6) `blueprint/sources/*.md`; COMPASS not injected. |
