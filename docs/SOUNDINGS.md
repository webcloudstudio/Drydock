...
| QuarterDeck standard artifacts | Captain's Chair, Soundings, and Sea Trials are the standard pinned Drydock Core artifacts of every Drydock QuarterDeck (orientation / acceptance criteria / objectives) | DONE | `docs/Drydock_Specification.md` § The QuarterDeck → Standard QuarterDeck Artifacts; `QuarterDeck/console.yaml` |
