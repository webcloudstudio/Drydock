...
`BUILD_COMPASS.md` defines the efficient, human-reviewable build path. It is not a flat
...
```text
# BUILD_COMPASS.md — <Target>
#
# GENERATED BY: drydock plan create
# DO NOT EDIT THIS FILE DIRECTLY.
# To change build order or grouping: edit it in QuarterDeck (Story Planning), or edit PLAN_COMPASS.md and re-run drydock plan create <Target>.
#
## 1: Foundation
