...
| 4 | `drydock config set blueprint_directory <path>` | Persist Blueprint root path | IMPLEMENTED | FUNCTIONAL TESTED | test_cli.py::TestConfigSet, test_config.py::TestConfigSet |
...
| 6 | `drydock init <Blueprint>` | Create Blueprint from Typed Specification templates | IMPLEMENTED | FUNCTIONAL TESTED | test_cli.py::TestInit, test_init_specification.py |
...
| 9 | `drydock validate <Blueprint>` | Validate Blueprint completeness | IMPLEMENTED | FUNCTIONAL TESTED | test_cli.py::TestValidate, test_validate_specification.py |
...
| 23 | `drydock iterate <Blueprint> <Target> [BOTH\|BLUEPRINT\|TGT] <Scope> <Change>` | Update Blueprint and target together | STUBBED | STUB TESTED | test_cli.py::TestStubs — exits 2, no files written |
...
| 25 | `drydock import <Blueprint> <Target> --format <auto\|source\|speckit>` | Reverse-engineer project into Blueprint | STUBBED | STUB TESTED | test_cli.py::TestStubs — exits 2, no files written |
